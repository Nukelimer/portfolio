			...
			<img
				...
				class={cn(
					...
					src == '/genz/notebook.webp' &&
						'absolute top-64 z-20   h-96.5 w-200 min-w-135 -rotate-28 object-cover  transition-all delay-300 duration-300 hover:scale-110 hover:-rotate-22  focus:-rotate-38 active:-rotate-38    sm:top-72  sm:max-w-152 [@media(min-width:339px)]:translate-y-12 [@media(min-width:359px)]:-translate-y-14 [@media(min-width:368px)]:translate-y-6 [@media(min-width:450px)]:top-76 [@media(min-width:450px)]:translate-y-12',
