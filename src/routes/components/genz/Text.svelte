<div
	...
	>
		...
		<h3 class="-translate-y-9 capitalize opacity-100 text-lg duration-300 hover:scale-110">
			Full-stack development
		</h3>
		<span class="mb-4 -translate-y-9 text-md capitalize italic duration-300 hover:scale-110"
			>noun & verb</span
		>

		<p class="max-w-xs -translate-y-9 text-md font-normal duration-300 hover:scale-110">
