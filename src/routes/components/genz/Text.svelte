...
<div
	class={cn(
		...
		mode == 'cleaned-up' && 'absolute z-40 ml-2 flex flex-col items-center justify-center font-medium text-black/70 top-[40%] right-12 transition-all duration-500 text-end ',
...
>
	...
	<span class="text-md mb-4 -translate-y-9 capitalize italic duration-300 hover:scale-110"
		>noun & verb</span
	>

	<p class="text-md max-w-xs -translate-y-9 font-normal duration-300 hover:scale-110">
